"""
GENESIS Phase 4B Quick Test: Open-Ended Learning
...
print("\n" + "="*70)
print("GENESIS Phase 4B: Quick Test (50 steps)")
print("="*70)
print()
...
# Run simulation
print("🚀 Running Phase 4B simulation (50 steps)...")
test_steps = 50
print_interval = 25
    ...
    if (step + 1) % print_interval == 0:
        ...
        if 'phase4b' in stats:
            ...
            if 'map_elites' in stats['phase4b']:
                ...
                print(f"  MAP-Elites Coverage: {me['coverage']:.1%} ({me['size']} bins)")
                print(f"  Avg Elite Fitness: {me['avg_fitness']:.3f}")

        print()

print("="*70)
print("Phase 4B Quick Test Complete!")
print("="*70)
print()
...
# Success criteria
print("✅ Phase 4B Test Result:")
success = True

if manager.novelty_search:
    if ns_stats['unique_behaviors'] > 5:
        print(f"  ✓ Discovered {ns_stats['unique_behaviors']} unique behaviors")
    else:
        print(f"  ⚠ Only {ns_stats['unique_behaviors']} unique behaviors (needs more steps)")

if manager.map_elites:
    coverage = me_stats['archive']['coverage']
    if coverage > 0.01:  # At least 1% coverage in 50 steps
        print(f"  ✓ MAP-Elites coverage: {coverage:.1%}")
    else:
        print(f"  ⚠ MAP-Elites coverage low: {coverage:.1%} (needs more steps)")

print(f"  ✓ Completed {test_steps} steps without errors")
print()
print("🎉 Phase 4B integration is functional!")
print()
